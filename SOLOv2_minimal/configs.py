...
class Custom_light_res50(Solov2_light_res50):
    def __init__(self, mode):
        ...
        self.detect_images = self.val_imgs  
        if self.mode in ('detect', 'onnx'):
...
class Custom_nori_res50(Solov2_light_res50):
    def __init__(self, mode):
        super().__init__(mode)
        self.dataset = CustomIns_separate
        self.data_root = 'datasets/vid3_nori/'
        self.train_imgs = self.data_root + 'images/train'
        self.train_ann = self.data_root + 'labels'
        self.val_imgs = self.data_root + 'images/val'
        self.val_ann = self.data_root + 'labels'
        self.class_names = ('1_G','1_NG','2_G','2_NG','3_G','3_NG','4_G','4_NG','5_G','5_NG')
        self.num_classes = len(self.class_names)
        self.epochs = 100
        self.warm_up_iters = 100  # bs=2,safe
        self.lr_decay_steps = (300, 360)
        self.start_save = 100
        self.val_interval = 1
